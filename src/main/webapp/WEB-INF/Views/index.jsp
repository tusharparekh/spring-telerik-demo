...
<head>
    ...
    <title>Telerik Controls Tester</title>
    <link href="${pageContext.request.contextPath}/telerik/styles/kendo.common.min.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/telerik/styles/kendo.default.min.css" rel="stylesheet" type="text/css" />

    <link href="${pageContext.request.contextPath}/telerik/styles/kendo.dataviz.min.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/telerik/styles/kendo.dataviz.default.min.css" rel="stylesheet" type="text/css" />

    <script type="text/javascript" src="${pageContext.request.contextPath}/telerik/js/jquery.min.js"></script>


    <script type="text/javascript" src="${pageContext.request.contextPath}/telerik/js/kendo.web.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/telerik/js/kendo.dataviz.min.js"></script>
</head>
<body>
<%

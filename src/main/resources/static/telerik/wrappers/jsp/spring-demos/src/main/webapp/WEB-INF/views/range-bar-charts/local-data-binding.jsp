...
<demo:header />
     <div class="demo-section k-content wide">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="rangeBar" fromField="fromA" toField="toA" categoryField="day" name="Task A"></kendo:chart-seriesItem>
                <kendo:chart-seriesItem type="rangeBar" fromField="fromB" toField="toB" categoryField="day" name="Task B"></kendo:chart-seriesItem>
             </kendo:chart-series>

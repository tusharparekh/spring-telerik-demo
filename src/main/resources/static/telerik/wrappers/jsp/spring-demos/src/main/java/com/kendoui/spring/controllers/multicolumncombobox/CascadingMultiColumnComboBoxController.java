...
@Controller("multicolumncombobox-cascadingmulticolumncombobox-controller")
@RequestMapping(value="/multicolumncombobox/")
public class CascadingMultiColumnComboBoxController {
    ...
    @RequestMapping(value = {"/cascadingmulticolumncombobox"}, method = RequestMethod.GET)
    public String index() {
        return "multicolumncombobox/cascadingmulticolumncombobox";
    }

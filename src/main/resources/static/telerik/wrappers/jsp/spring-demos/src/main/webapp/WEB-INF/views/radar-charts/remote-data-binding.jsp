...
<demo:header />
   <div class="demo-section k-content wide">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="radarLine" field="budget" categoryField="unit" name="Budget" />
                <kendo:chart-seriesItem type="radarLine" field="spending" categoryField="unit" name="Spending" />
             </kendo:chart-series>

...
<demo:header />
     <div class="demo-section k-content wide">
         <kendo:chart name="chart">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="area" field="nuclear" categoryField="year" name="Nuclear" />
                <kendo:chart-seriesItem type="area" field="hydro" categoryField="year" name="Hydro" />
                <kendo:chart-seriesItem type="area" field="wind" categoryField="year" name="Wind" />
             </kendo:chart-series>

...
@Controller("treelist-editing-incell-controller")
@RequestMapping(value="/treelist/")
public class EditingIncellController {
    
    @Autowired 
    private EmployeeDirectoryDao employeeDirectory;
    
    @RequestMapping(value = "/editing-incell", method = RequestMethod.GET)
    public String index() {
        return "treelist/editing-incell";
    }
    
    @RequestMapping(value = "/editing-incell/read", method = RequestMethod.POST)
    public @ResponseBody List<EmployeeDirectory> read() {
        return employeeDirectory.getList();
    }
    
    @RequestMapping(value = "/editing-incell/update", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/editing-incell/create", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/editing-incell/destroy", method = RequestMethod.POST)

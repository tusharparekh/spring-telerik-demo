...
<demo:header />
    ...
    <kendo:grid name="grid" filterable="true" groupable="true" pageable="true" height="540px" sortable="true" scrollable="true" editable="true">
        ...
        <kendo:grid-columns>
            ...
            <kendo:grid-column title="Category" field="categoryId" width="200px" dataTextField="CategoryName" dataValueField="CategoryID">
            	<kendo:dataSource type="odata">
            		<kendo:dataSource-transport>
            			<kendo:dataSource-transport-read url="https://demos.telerik.com/kendo-ui/service/Northwind.svc/Categories"  />
            		</kendo:dataSource-transport>
            	</kendo:dataSource>
            </kendo:grid-column>

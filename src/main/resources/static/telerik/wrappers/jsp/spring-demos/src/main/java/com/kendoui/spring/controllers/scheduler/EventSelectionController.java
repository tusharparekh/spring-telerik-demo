...
@Controller("scheduler-event-selection-controller")
@RequestMapping(value="/scheduler/")
public class EventSelectionController {
    @Autowired 
    private TaskDao task;
    
    @RequestMapping(value = {"/event-selection"}, method = RequestMethod.GET)
    public String index(Locale locale, Model model) {        
        return "scheduler/event-selection";
    }
    
    @RequestMapping(value = "/event-selection/read", method = RequestMethod.POST)
    public @ResponseBody List<Task> read() {
        return task.getList();
    }
    
    @RequestMapping(value = "/event-selection/create", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/event-selection/update", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/event-selection/destroy", method = RequestMethod.POST)

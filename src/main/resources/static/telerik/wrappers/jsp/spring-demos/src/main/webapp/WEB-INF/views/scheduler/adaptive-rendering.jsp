...
<c:url value="/scheduler/adaptive-rendering/read" var="readUrl" />
<c:url value="/scheduler/adaptive-rendering/create" var="createUrl" />
<c:url value="/scheduler/adaptive-rendering/update" var="updateUrl" />
<c:url value="/scheduler/adaptive-rendering/destroy" var="destroyUrl" />
...
<demo:header />
    <div id="example">
        <div id="qr-wrap" style="text-align: center;">
            ...
            <kendo:qRCode name="qrMobile" size="170" border-color="#000" border-width="5" style="display: inline-block; margin-top: 20px;">
            </kendo:qRCode>
        </div>
        <div id="scheduler-wrap" style="display: none;">
            <kendo:scheduler name="scheduler" mobile="<%= true %>" timezone="Etc/UTC" height="450" date="<%= date %>" startTime="<%= startTime %>">

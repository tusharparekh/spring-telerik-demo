...
<demo:header />
	...
	<kendo:pivotGrid name="pivotgrid" columnWidth="120" height="570px" class="hidden-on-narrow" sortable="true" filterable="true">
		...
		<kendo:pivotDataSource data="${products}">
			...
			<kendo:pivotDataSource-rows>
				<kendo:pivotDataSource-row name="discontinued" expand="true"/>
			</kendo:pivotDataSource-rows>

...
<div id="example">
    <div class="box wide">
	    ...
	    <p>More information regarding the resizable functionality can be found in the <a href="https://docs.telerik.com/kendo-ui/web/toolbar/overview">Getting Started topic</a>.</p>

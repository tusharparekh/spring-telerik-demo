...
<c:url value="/scheduler/date-grouping/read" var="readUrl" />
<c:url value="/scheduler/date-grouping/create" var="createUrl" />
<c:url value="/scheduler/date-grouping/update" var="updateUrl" />
<c:url value="/scheduler/date-grouping/destroy" var="destroyUrl" />
...
<demo:header />
	<div class="box wide">
		<div class="box-col">
			...
			<kendo:dropDownList name="orientation" dataTextField="text" dataValueField="value">
				<kendo:dataSource data="${orientation}"></kendo:dataSource>
    ...
    <kendo:scheduler name="scheduler" timezone="Etc/UTC" height="600" date="<%= date %>" startTime="<%= startTime %>">
    	...
    	<kendo:scheduler-group date="true" resources="<%= new String[] { \"Rooms\" } %>"/>

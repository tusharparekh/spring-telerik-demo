...
@Controller("scheduler-timeline-night")
@RequestMapping(value="/scheduler/")
public class TimelineNightController {
    @Autowired 
    private MeetingDao meeting;
    
    @RequestMapping(value = "/timeline-night", method = RequestMethod.GET)
    public String resources(Locale locale, Model model) {        
        return "scheduler/timeline-night";
    }
}
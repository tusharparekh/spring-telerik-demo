...
<c:url value="/treelist/column-menu/read" var="transportReadUrl" />

<demo:header /> 
 
<kendo:treeList name="treelist" columnMenu="true" filterable="true" sortable="true">
	<kendo:treeList-columns>
		...
		<kendo:treeList-column field="extension" title="Ext" format="{0:#}" filterable="false"></kendo:treeList-column>		
	</kendo:treeList-columns>
	<kendo:dataSource>

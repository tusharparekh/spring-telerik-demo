...
<kendo:fileManager name="fileManager" resizable="true" draggable="true" uploadUrl="https://demos.telerik.com/kendo-ui/service/FileManager/Upload" >
	...
	<kendo:fileManager-toolbar>
		<kendo:fileManager-toolbar-items>
			...
			<kendo:fileManager-toolbar-item name="sortDirection"></kendo:fileManager-toolbar-item>

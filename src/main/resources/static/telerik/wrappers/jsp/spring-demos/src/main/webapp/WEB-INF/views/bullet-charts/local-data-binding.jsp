...
<demo:header />
     <div class="demo-section k-content wide">
         <kendo:chart name="chart-mmHg">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="verticalBullet" color="#ffffff" opacity="0.8" currentField="current" targetField="target" categoryField="category">
         ...
         <kendo:chart name="chart-hPa">
             ...
             <kendo:chart-series>
                <kendo:chart-seriesItem type="verticalBullet" data="${hPaData}" color="#ffffff" opacity="0.8" currentField="current" targetField="target" categoryField="category">
                	<kendo:chart-seriesItem-target color="#ffffff" />
                </kendo:chart-seriesItem>
             </kendo:chart-series>
             <kendo:chart-valueAxis>
             ...
             <kendo:chart-categoryAxis>
                <kendo:chart-categoryAxisItem axisCrossingValue="14">
             		<kendo:chart-categoryAxisItem-majorGridLines visible="false" />
             		<kendo:chart-categoryAxisItem-majorTicks visible="false" />

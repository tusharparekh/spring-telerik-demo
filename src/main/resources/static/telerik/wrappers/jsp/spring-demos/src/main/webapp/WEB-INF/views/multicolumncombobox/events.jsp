...
<demo:header />
    <div class="demo-section k-content">
        <h4>ComboBox</h4>
        <kendo:multiColumnComboBox name="combobox" open="onOpen" close="onClose" change="onChange" dataBound="onDataBound" select="onSelect"
    ...
    <script>
        ...
        function onSelect(e) {
            if ("kendoConsole" in window && e.item) {

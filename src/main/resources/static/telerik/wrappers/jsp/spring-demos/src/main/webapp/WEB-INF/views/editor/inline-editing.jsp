...
<div id="example">
   <div class="demo-section wide k-content">
		...
		<kendo:editor name="leftColumn" tag="div" class="column">
		    <kendo:editor-value>
		        ...
		        <p>
		            ...
		            <a href="https://www.telerik.com/kendo-ui" title="Kendo UI Web">Kendo UI Web</a>.
		        </p>
		    </kendo:editor-value>
		</kendo:editor>
		<kendo:editor name="centerColumn" tag="div" class="column">
		    <kendo:editor-value>
		        ...
		        <p>
		            <a href="https://www.telerik.com/kendo-ui" title="Kendo UI Mobile">Kendo UI Mobile</a>
		            is packed with easy-to-use jQuery-based widgets and built-in
		            rich components for your fast mobile application development.
		        </p>
		    </kendo:editor-value>
		</kendo:editor>
		<kendo:editor name="rightColumn" tag="div" class="column">
		    <kendo:editor-value>
		        ...
		        <p>
		            <a href="https://www.telerik.com/kendo-ui" title="Kendo UI DataViz">Kendo UI DataViz</a>
...
<div class="box wide">
    ...
    <p>
        ...
        <a href="https://docs.telerik.com/kendo-ui/getting-started/web/editor/troubleshooting#inline-editor-value-is-not-posted-to-the-server">how to post the inline editor value</a> help section.
    </p>
</div>
<style>
    .k-editor-inline {
